...
- additive same-session and different-session overlap compatibility on connected clients through per-session FIFO turn tracking in `ClaudeQuerySession`
