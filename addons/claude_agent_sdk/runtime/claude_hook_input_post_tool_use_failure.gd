...
class_name ClaudeHookInputPostToolUseFailure

var tool_name: String = ""
var tool_input: Dictionary = {}
var tool_use_id: Variant = null
var error: String = ""
var is_interrupt: Variant = null
...
func apply(config: Dictionary):
	...
	if config.has("is_interrupt") or config.has("isInterrupt"):
		is_interrupt = _get_first(config, ["is_interrupt", "isInterrupt"])
...
func to_dict() -> Dictionary:
	...
	if is_interrupt != null:
		result["is_interrupt"] = bool(is_interrupt)
	if agent_id != null:
