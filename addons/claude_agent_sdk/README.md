...
- `ClaudeClientAdapter`
- `ClaudeClientNode`
- `ClaudeChatPanel` with saved-session browsing, transcript restoration, transcript granularity filters, disconnected connect-and-send composer behavior, idle-time live switching, resume, basic rename/tag/delete controls, and disconnected prompt/tool configuration controls
